...
ggplot(results, aes(x = T, y = power, color = df1)) +
  ...
  labs(title = "Test 2", x = "Stikprøvestørrelse T", y = "Power", color = "Teststørrelse") +
  theme_minimal()
```
...
ggplot(results2, aes(x = T, y = power, color = df1)) +
  ...
  geom_line() +
  scale_y_continuous(limits = c(0, 1)) +
  labs(title = "Test 3", x = "Stikprøvestørrelse T", y = "Power", color = "Teststørrelse") +
  theme_minimal()
```
...
ggplot(results3, aes(x = T, y = power, color = df1)) +
  ...
  geom_line() +
  scale_y_continuous(limits = c(0, 1)) +
  labs(title = "Test 4", x = "Stikprøvestørrelse T", y = "Power", color = "Teststørrelse") +
  theme_minimal()
```
